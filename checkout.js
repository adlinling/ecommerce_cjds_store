...
function customer(paymethod, diffaddr, accountnum, referenceid, email, firstname, lastname, address1, address2, city, state, country, zip, phone, totalamt, ip){
...
function changeshipping(billorship, productsjsonurl) {
